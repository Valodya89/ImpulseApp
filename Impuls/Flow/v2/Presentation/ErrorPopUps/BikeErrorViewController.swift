//
//  BikeErrorViewController.swift
//  MimoBike
//
//  Created by Razmik Mkhitaryan on 05.04.24.
//

import UIKit

class BikeErrorViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let scooterImageView = UIImageView(image: "Mimo_bike_New".image)
