...
final class DateHelper {
    ...
    static func convertDateStringToTimeStamp(dateString: String, pattern: String = "mm:ss:pp") -> Int {
        
        let dateFormatter = DateFormatter()
        dateFormatter.dateFormat = pattern
        let convertedDateObject = dateFormatter.date(from: dateString)
        return Int(convertedDateObject?.timeIntervalSince1970 ?? 0)
    }
    
    static func convertDateStringToDateObject(dateString: String, pattern: String = "mm:ss:pp") -> Date? {
